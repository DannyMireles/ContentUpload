  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-4xl items-center px-4 py-10 sm:px-6 lg:px-8">
      <section className="panel w-full rounded-[2.5rem] p-8 sm:p-10">
        <div className="text-xs uppercase tracking-[0.28em] text-rose-900/60">Request access</div>
        <h1 className="mt-4 text-4xl">Get an invite code</h1>
        <p className="mt-4 text-sm leading-6 text-rose-900/70">
          Enter your work email. We&apos;ll send a verification code. Access is granted once your account is approved.
        </p>
